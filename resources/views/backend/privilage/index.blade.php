                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="{{ route('privilage.edit', $privilage->id_privilage) }}">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a class="btn btn-sm btn-danger" href="{{ route('privilage.destroy', $privilage->id_privilage) }}" data-confirm-delete="true">
