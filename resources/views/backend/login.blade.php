...
<head>
    ...
    <style>
        ...
        #auth #auth-right {
            height: 100%;
            background: url("https://rizqunatravel.com/wp-content/uploads/elementor/thumbs/Rizquna-8-q8keek5vrzun9zryx6kwb8zxyayinm1lo323prgrls.jpg"),
    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-4 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <img src="{{asset('backend/img/logo2.png')}}" alt="Logo" style="height: 100px">
                    </div>
